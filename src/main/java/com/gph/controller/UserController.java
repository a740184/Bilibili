...
public class UserController {
    ...
    {
        //获取当前登录的用户信息
        String login_name= cookieUtil.getCookieName(request,"loginName");
    ...
    public String upload_video(@RequestParam(value = "upfile")MultipartFile[] upfile, HttpServletRequest request,String vname ,Integer typeId) throws ParseException {
        User userInfo = userSerivceImpl.selectInfoByUserName(cookieUtil.getCookieName(request,"loginName"));
        String vImage = "";
        String vsrc = "";
