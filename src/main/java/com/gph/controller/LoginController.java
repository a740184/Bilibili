...
import com.gph.model.Information;
...
public class LoginController {
    ...
    public Information login(HttpServletRequest request, HttpServletResponse response,HttpSession session) throws UnsupportedEncodingException {
        ...
        {
            session.setAttribute("userSession",list_user_info);
